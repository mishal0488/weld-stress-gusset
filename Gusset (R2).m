...
P1 = [0 0];
P2 = [0 291];
P3 = [284 291]; #load point
P4 = [91 0];

Load = [3 9.5*1000 9.5*1000];
...
npe = 3 #nodes per element
      ...
      pv = [P1(1,1) P1(1,2);P2(1,1) P2(1,2);P3(1,1) P3(1,2);P4(1,1) P4(1,2);P1(1,1) P1(1,2)];
      fd = { 'l_dpolygon', [], pv };
      fh = @(p) ones(size(p,1),1);
      [p,T] = distmesh( fd, fh, 0.01, [-5,-5;5,5],pv);
